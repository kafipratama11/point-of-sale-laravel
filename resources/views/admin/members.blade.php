...
<div class="d-flex main-container">
      ...
      <div class="w-100">
            ...
            <div class="px-4 d-flex mt-3">
                  <div class="me-auto fw-medium">Membership</div>
                  <button type="button" class="btn background-primary text-white btn-add"><i class="bi bi-plus-lg"></i> New Member</button>
            </div>
            <div class="px-4 mt-3">
